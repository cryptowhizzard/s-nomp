...
module.exports = function() {
    ...
    // Constants
    var version         = '0.1.0',
        PUBLIC_API_URL  = 'https://api.crex24.com/v2/public',
        PRIVATE_API_URL = 'https://api.crex24.com/v2/trading',
        USER_AGENT      = 'nomp/node-open-mining-portal'

    // Constructor
    function Crex24(key, secret){
        ...
        this._getPrivateHeaders = function(parameters){
            ...
            if (!key || !secret){
                throw 'Crex24: Error. API key and secret required';
            }
    ...
    Crex24.prototype = {
        ...
        _request: function(options, callback){
            ...
            options.json = true;
            options.strictSSL = Crex24.STRICT_SSL;

            request(options, function(err, response, body) {
		//console.log('CREX Api Request initiated' + JSON.stringify(body));
                callback(err, body);
            });
        ...
        getOrderBook: function(currencyA, currencyB, callback){
             var options = {
                 method: 'GET',
                 url: PUBLIC_API_URL + '/orderBook?instrument=' + currencyB.toUpperCase() + '-' + currencyA.toUpperCase() + '&limit=1',
                 //qs: null
             };

	     //console.log('CREX Api Orderbook initiated' + JSON.stringify(options));
             return this._request(options, callback);
        },
